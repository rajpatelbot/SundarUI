        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-2 mt-28">
          ...
          <div className="m-auto">
            ...
            <p className="mt-5">
              ...
              frameworks. Exceptional customer support and up-to-date components
          ...
          <div className="sm:m-auto lg:m-auto mt-10 md:m-auto sm:mt-10">
            ...
            <div className="mt-5">
              <p>
                Our motivation Empowering Web Development with Accessible and
                Hassle-Free Prebuilt Components.
              </p>
