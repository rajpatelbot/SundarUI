  ...
  return (
    <main>
      ...
      <div className="bg-offWhite h-full py-20">
        <MaxWidthContainer>
          <div className="mx-auto max-w-4xl">
            <BodyText className="pb-4 text-center text-violet-500 font-bold">
              {" "}
              Supercharge Your Development{" "}
            </BodyText>
            <Heading className="font-bold mb-4 text-center">
              Efficient development with prebuilt components
            </Heading>
            <BodyText className="mb-8 text-center max-w-5xl mx-auto">
              Enhance your web and mobile app development using a versatile set
              of open-source components, designed with Tailwind CSS, XML.
            </BodyText>
      ...
      <MaxWidthContainer className="my-12">
        <SubHeading className="text-center font-bold">
      ...
      <div className="bg-darkPurple py-12" id="components">
        <MaxWidthContainer>
          <SubHeading className="text-center text-white font-bold">
            Tailwind components
          </SubHeading>
      ...
      <MaxWidthContainer className="my-12">
        ...
        {FaqsData.map((data) => (
          <details
            key={uuidv4()}
            className="group border-l-4 border-darkPurple bg-white p-2 my-5">
