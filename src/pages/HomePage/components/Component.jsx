...
import { WebComponents } from '../../../API/ComponentsInfo';
  ...
  return (
    <div className="padding-px py-24 bg-lightRed">
      <div className="maxWidth m-auto">
        ...
        />
        <Componentlayout webSubset={webSubset} heading={'Tailwind CSS components'} />
        <Componentlayout webSubset={webSubset} heading={'Mobile components'} />
      </div>
    </div>
  );
};
